...
def get_optimizer(
    ...
    """
    Factory to instantiate the chosen optimizer with weight decay.
    """
...
def train_model(
    ...
    pbar = tqdm(range(1, epochs + 1), desc=f"🧠 Training {model_name} [{optimizer_name}]", unit="epoch", leave=leave_pbar)
